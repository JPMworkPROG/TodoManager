                        ...
                        <TableHeader>
                           <TableRow>
                              <TableHead className="w-28">
                                 <Tooltip>
                                    <TooltipTrigger asChild>
                                       <span className="cursor-help">SKU</span>
                                    </TooltipTrigger>
                                    <TooltipContent side="top" sideOffset={8}>
                                       <p>Código único de identificação do item</p>
                                    </TooltipContent>
                                 </Tooltip>
                              </TableHead>
                              <TableHead>
                                 <Tooltip>
                                    <TooltipTrigger asChild>
                                       <span className="cursor-help">Descrição</span>
                                    </TooltipTrigger>
                                    <TooltipContent>
                              ...
                              <TableHead className="w-44 text-right">
                                 <Tooltip>
                                    <TooltipTrigger asChild>
                                       <span className="cursor-help">Total Produ (tons)</span>
                                    </TooltipTrigger>
                                    <TooltipContent>
                              ...
                              <TableHead className="w-24 text-center">
                                 <Tooltip>
                                    <TooltipTrigger asChild>
                                       <span className="cursor-help">Ações</span>
                                    </TooltipTrigger>
                                    <TooltipContent side="top" sideOffset={8}>
                                       <p>Editar ou excluir o item</p>
                                    </TooltipContent>
                                 </Tooltip>
                              </TableHead>
                           </TableRow>
